...
MultipleForms.copy(:CACNEA,:CACTURNE,:SANDYGAST,:PALOSSAND,:DEINO,:ZWEILOUS,:HYDREIGON,:TRAPINCH,:HORSEA,:SEADRA,:EXEGGCUTE,:EXEGGUTOR,:SEEL,:DEWGONG,:QWILFISH,:LUVDISC,:DROWZEE)
